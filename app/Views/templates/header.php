...
<head>
    ...
    <link rel="alternate" type="application/rss+XML" title="ChopesGames" href="<?php echo site_url(
        'AdministrateurSuper/flux_rss'
    ); ?>" />
...
<body>
    <nav class="navbar navbar-expand-sm bg-dark lighten-4">
    <div class="container-fluid">
        <!-- Navbar brand -->
            <a class="navbar-brand" href="<?php echo site_url(
                'Visiteur/accueil'
            ); ?>">
                <img width="60" height="38" src="<?php echo base_url(
  ...
  <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM3.102 4l1.313 7h8.17l1.313-7H3.102zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
    ...
    echo "($nb)";
                ...
                <?php if (
                    $session->get('statut') == 2 or
                    $session->get('statut') == 3
                ): ?>
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" href="<?php echo site_url(
                                'AdministrateurEmploye/afficher_les_clients'
                            ); ?>">Clients->Commandes</a>
                            <a class="dropdown-item" href="">(2Do) Commandes non traitées</a>
                            <?php if ($session->get('statut') == 3) { ?>
                                <a class="dropdown-item" href="<?php echo site_url(
                                    'AdministrateurSuper/ajouter_un_produit'
                                ); ?>">Ajouter un produit</a>
                                <a class="dropdown-item" href="<?php echo site_url(
                                    'AdministrateurSuper/modifier_identifiants_bancaires_site'
                                ); ?>">Modifier identifiants bancaires site</a>
                            <?php } ?>
                        </div>
                    </li>
                <?php endif; ?>
  ...
  <?php if (!is_null($session->get('statut'))) { ?>
                            <?php if ($session->get('statut') == 1) { ?>
                                <a class="dropdown-item" href="<?php echo site_url(
                                    'Client/historique_des_commandes'
                                ); ?>">Mes commandes</a>
                                <a class="dropdown-item" href="<?php echo site_url(
                ...
                <?php if (empty($session->get('statut'))): ?>
                    <li class="nav-item droite">
                        <a href="<?php echo site_url(
                            'Visiteur/connexion_administrateur'
                        ); ?>">Admin</a>
                    </li>
                <?php endif; ?>
            </ul>
