<div class="container-fluid">
  <div class="row">
    <div class="col-sm-10">
      <div class="container"  style="width:300px;height:380px;" id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              foreach ($vitrines as $vitrine) :
                ...
                <div class="carousel-item <?php echo $class; ?>">
                  <a href="<?php echo site_url('Visiteur/voir_un_produit/' . $vitrine["NOPRODUIT"]); ?>">
