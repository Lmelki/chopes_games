...
<div class="col-md-3 col-sm-6">
            <div class="product-grid">
                ...
                <a href="<?php  echo site_url().'/index.php/Visiteur/voir_un_produit/'.$unProduit["NOPRODUIT"]?>">
                                   <?php  
                ...
                <div class="product-content">
                    <h3 class="title"><a href="<?php  echo site_url('Visiteur/voir_un_produit/'.$unProduit["NOPRODUIT"]);?>"><?php echo $unProduit["LIBELLE"] ?></a>
